...
// ---- Bound expressions -----------------------------------------------------
public abstract class BoundExpr { public required TypeSymbol Type; }
...
public sealed class BoundParam : BoundExpr { public required ParamSymbol Symbol; }
...
public enum ConsoleKind { WriteLine, Write }
...
public sealed class BoundExprStmt : BoundStmt { public required BoundExpr Expression; }
...
public sealed class BoundReturn : BoundStmt { public BoundExpr? Value; }
